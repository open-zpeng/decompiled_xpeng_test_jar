...
public class CarTest {
    ...
    public void registerAllCallBack() {
        while (this.mCarMcuManager == null) {
            try {
                Thread.sleep(1000L);
            } catch (Exception e) {
                e.printStackTrace();
        ...
        try {
            this.mCarMcuManager.registerCallback(this.mTestCallBack);
        } catch (Exception e2) {
            String str = this.TAG;
    ...
    public int getDiagPropList() {
        ...
        try {
            List<CarPropertyConfig> list = this.mXpDiagnosticManager.getPropertyList();
            int ret = list.size();
            return ret;
        } catch (Exception e) {
            String str = this.TAG;
