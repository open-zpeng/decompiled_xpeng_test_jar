...
public class BluetoothTest {
    ...
    public void closeProfileProxy() {
        if (this.mPbapClient != null) {
            this.mAdapter.closeProfileProxy(17, this.mPbapClient);
        }
        if (this.mHeadsetClient != null) {
            this.mAdapter.closeProfileProxy(16, this.mHeadsetClient);
        }
        if (this.mA2dpSink != null) {
            this.mAdapter.closeProfileProxy(11, this.mA2dpSink);
        }
        if (this.mHeadset != null) {
            this.mAdapter.closeProfileProxy(1, this.mHeadset);
        }
        if (this.mA2dp != null) {
            this.mAdapter.closeProfileProxy(2, this.mA2dp);
        }
        if (this.mPbap != null) {
            this.mAdapter.closeProfileProxy(6, this.mPbap);
        }
        if (this.mSap != null) {
            this.mAdapter.closeProfileProxy(10, this.mSap);
        }
        if (this.mHearingAid != null) {
            this.mAdapter.closeProfileProxy(21, this.mHearingAid);
        }
        if (this.mMapClient != null) {
            this.mAdapter.closeProfileProxy(18, this.mMapClient);
        }
        if (this.mHidHost != null) {
            this.mAdapter.closeProfileProxy(4, this.mHidHost);
        }
        if (this.mPan != null) {
        ...
        if (this.mAvrcpController != null) {
            this.mAdapter.closeProfileProxy(12, this.mAvrcpController);
        }
    }
